                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link border-0" to="/Products">
                                    Products
                                </NavLink>
                            </li>
                            <li className="nav-item dropdown">
                                <NavLink className="nav-link border-0" to="/about">
                                    About
                                </NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink className="nav-link border-0" to="/contact">
                                    Contact
                                </NavLink>
                            </li>
                        </ul>
